...
export class ApiConnector {
    ...
    static throwIfError<T>(r : ApiResponse<T>) {
        if (r.error !== false) {
    ...
    static async bulletinHas(bulletin : ExpandedPAGASADocument, options?: RequestInit)
        : Promise<{ downloaded: boolean, parsed: boolean }> {
    ...
    static async bulletinDownload(bulletin : ExpandedPAGASADocument, options?: RequestInit)
    ...
    static async bulletinParse(bulletin : ExpandedPAGASADocument, options?: RequestInit)
        : Promise<Bulletin> {
    ...
    static async formatWikipedia(data?: string | Bulletin | ExpandedPAGASADocument, options?: RequestInit)
        : Promise<string> {
        let fetchPromise;
